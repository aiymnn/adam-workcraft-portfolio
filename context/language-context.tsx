...
const en: Dict = {
  ...
  about: { label: 'About', heading: 'Every frame is a story\nwaiting to be told.', paragraph: 'Based in Johor, we craft visual legacies. We believe the most powerful images are felt, not just seen. Captured with patience and an obsessive eye for light, we turn fleeting moments into timeless art. Whether it\'s an intimate wedding or a corporate campaign, our mission is simple: tell your truth, craft it beautifully, and let the story breathe.', location: 'Professional studio based in Johor — available for travel worldwide based on date availability.', stats: { weddings: 'Weddings', events: 'Events', experience: 'Years', clients: 'Clients' }, servicesLabel: 'Services' },
